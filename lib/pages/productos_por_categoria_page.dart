...
class _ProductosPorCategoriaPageState extends State<ProductosPorCategoriaPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: esMovil ? _drawerCategorias() : null, // 👈 izquierda móvil
      endDrawer: const CarritoDrawer(), // 👈 derecha siempre
      body: SafeArea(
    ...
    final items = <Widget>[
      ...subCategorias.map(
        (sub) => _chipSubcategoria(
          icono: IconosCategoriaHelper.obtenerIcono(sub.icono),
          nombre: sub.nombre,
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _seccionSubcategorias(esMovil: false),
                  const SizedBox(height: 20),
                  CatalogoGridWidget(
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.categoriaActiva.nombre[0].toUpperCase() +
                          widget.categoriaActiva.nombre
                              .substring(1)
                              .toLowerCase(),
                      style: TextStyle(
